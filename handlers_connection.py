...
async def connect_navan(ctx, params: ConnectParams) -> ActionResult[ConnectionRecord]:
...
async def disconnect_navan(ctx, params: ConnectionIdParams) -> ActionResult[DeleteResult]:
