"""Pydantic schemas for Navan Connector (C29. Expense Management & Corporate Cards)."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Acme Navan.")
